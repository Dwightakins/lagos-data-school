...
const SECTIONS: Section[] = [
  {
    ...
    fields: [
      ...
      { key: "school_url", label: "Website URL", type: "url", placeholder: "https://lagosdataschoolltd.com" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "email_from_address", label: "From Address", type: "email", placeholder: "noreply@lagosdataschoolltd.com" },

...
const BASE_INPUT =
  "w-full px-3.5 py-2.5 rounded-lg border text-[14px] text-gray-900 placeholder-gray-400 bg-white focus:outline-none focus:ring-2 transition-all";

function field(err: string) {
  return err
    ? `${BASE_INPUT} border-red-400 focus:ring-red-200 focus:border-red-400`
    : `${BASE_INPUT} border-gray-300 focus:ring-[#0056D2]/20 focus:border-[#0056D2]`;
}
...
export default function Step1Personal({
  ...
  return (
    <div>
      <h2 className="text-[1.4rem] font-bold text-gray-900 mb-1">Create your account</h2>
      <p className="text-[13.5px] text-gray-500 mb-6">Join thousands of students building in-demand skills.</p>
      ...
      <button
        ...
        className="mt-6 w-full bg-[#0056D2] hover:bg-[#0047B3] text-white font-semibold text-[14.5px] py-2.5 rounded-lg transition-colors shadow-sm"
      >
        Continue →
      </button>

...
const socials = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/lagosdataschool",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/lagosdataschool",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: "X",
    href: "https://x.com/lagosdataschool",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@lagosdataschool",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-16 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 pb-14 border-b border-white/[0.07]">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[13.5px] text-white/62 leading-relaxed max-w-[220px] mb-6">
              Equipping the next generation of African tech professionals with world-class,
              affordable, practical skills.
            </p>
            <p className="text-[13px] text-white/55 mb-7">Lagos, Nigeria</p>
            <div className="flex items-center gap-2.5">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 rounded-lg bg-white/7 hover:bg-[#1A56DB] flex items-center justify-center text-white/68 hover:text-white transition-colors"
                >
                  {s.icon}
                </a>
              ))}
